...
import { createMessage, getMessages, markMessageAsRead, getChatList, getConversationsByUserId } from '../controllers/message.controller.js';
...
router.get('/conversations/:userId', restrictTo('admin', 'superadmin'), getConversationsByUserId);
